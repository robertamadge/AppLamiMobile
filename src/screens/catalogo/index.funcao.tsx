...
import { ImageBackground, View , StyleSheet, Image, ScrollView, useWindowDimensions} from 'react-native';
        ...
        <View style={{flexDirection:'column'}}>
          <View style={{flexDirection:'row'}}>
            <Card containerStyle={styles.cards}>
              ...
              <ButtonCatalogo novoTextoServidor={(texto) => console.log(texto)} icon='cart-outline'/>
            </Card>
