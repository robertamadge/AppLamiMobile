...
export interface ColaresScreenProps {
 
}

export function ColaresScreen (props: ColaresScreenProps) {
        ...
        <View style={{flexDirection:'column'}}>
          <View style={{flexDirection:'row'}}>
            <Card containerStyle={styles.cards}>
              <Image source={require('../../img/colar1.png')} style={styles.imgCard}/>
              <Text style={styles.textoClique}>Colar Indiano</Text>
            ...
            <Card containerStyle={styles.cards}>
              ...
              <Text style={styles.textoClique}>Colar Onda</Text>
              <Text style={styles.textoClique}>R$: 10,00</Text>             
               <ButtonCatalogo icon='cart-outline'/>
            </Card>
          </View>
          <View style={{flexDirection:'row'}}>
            <Card containerStyle={styles.cards}>
              <Image source={require('../../img/colar3.png')} style={styles.imgCard}/>
              <Text style={styles.textoClique}>Colar Lua</Text>
              <Text style={styles.textoClique}>R$: 10,00</Text>             
              <ButtonCatalogo icon='cart-outline'/>
            </Card>

            <Card containerStyle={styles.cards}>
              <Image source={require('../../img/colar4.png')} style={styles.imgCard}/>
              <Text style={styles.textoClique}>Colar Be Brave</Text>
              <Text style={styles.textoClique}>R$: 10,00</Text>             
               <ButtonCatalogo icon='cart-outline'/>
            </Card>
          </View>
          <View style={{flexDirection:'row'}}>
            <Card containerStyle={styles.cards}>
              <Image source={require('../../img/colar5.png')} style={styles.imgCard}/>
              <Text style={styles.textoClique}>Colar Corações</Text>
              <Text style={styles.textoClique}>R$: 10,00</Text>             
              <ButtonCatalogo icon='cart-outline'/>
            </Card>

            <Card containerStyle={styles.cards}>
              <Image source={require('../../img/colar6.png')} style={styles.imgCard}/>
              <Text style={styles.textoClique}>Colar BOHO</Text>
              <Text style={styles.textoClique}>R$: 10,00</Text>             
               <ButtonCatalogo icon='cart-outline'/>
            </Card>
          </View>
